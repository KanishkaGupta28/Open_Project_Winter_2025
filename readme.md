...
`notebooks/scalability_analysis.ipynb`

This notebook:

- Loads `results/scalability_results.csv`
- Generates fidelity and runtime plots
- Saves `fidelity_plot.png` and `runtime_plot.png`
